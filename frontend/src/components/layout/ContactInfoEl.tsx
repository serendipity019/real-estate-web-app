          ...
          <div className="flex flex-col items-center w-[360px] text-white font-semibold bg-[#f6f6f6]">
            ...
            <div className="flex flex-col items-center">
                ...
                <hr className="h-0.5 bg-re-dark mb-8 w-[300px]" />
                      ...
                      <span className="text-re-dark mt-2">Διεύθυνση </span>
                      <a href= "https://maps.app.goo.gl/98GTbrz7ZqqdZgsx7" className="text-re-light hover:text-re-dark ml-2">Πατησίων 76, Αθήνα 10434</a>                
            </div>            
          </div>
        </>
    );
